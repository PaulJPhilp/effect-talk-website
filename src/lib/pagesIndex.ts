...
export const sitePages: readonly SitePage[] = [
  {
    ...
    href: "/",
    description:
      "EffectTalk — Production-ready Effect.ts patterns, tools, and consulting.",
  },
  {
    title: "EffectPatterns CLI",
    href: "/cli",
    description:
      "Install and use the EffectPatterns CLI to search, browse, and install Effect.ts patterns from your terminal.",
  },
  {
    title: "EffectPatterns MCP Server",
    href: "/mcp",
    description:
      "Connect your AI assistant to EffectPatterns via the MCP server.",
  },
  {
    title: "EffectPatterns Playground",
    href: "/playground",
    description:
      "Interactive playground for experimenting with Effect.ts patterns.",
  },
  {
  ...
  },
  {
    ...
    href: "/patterns",
    description:
      "Browse all Effect.ts patterns — searchable, categorized, and production-tested.",
  },
  {
    title: "Rules",
    href: "/rules",
    description:
      "Browse all Effect.ts rules for code quality and best practices.",
  },
  {
    title: "Consulting",
    href: "/consulting",
    description:
      "Effect.ts consulting — assessments, migration strategy, and developer training.",
  },
  {
    title: "Search",
    href: "/search",
