...
export const SESSION_MAX_AGE_SECONDS =
  SECONDS_PER_MINUTE * MINUTES_PER_HOUR * HOURS_PER_DAY * DAYS_PER_MONTH; // 30 days
...
export const WORKOS_AUTHORIZE_ENDPOINT =
  `${WORKOS_API_BASE_URL}/user_management/authorize` as const;
export const WORKOS_AUTHENTICATE_ENDPOINT =
  `${WORKOS_API_BASE_URL}/user_management/authenticate` as const;
...
export const EMAIL_FROM_ADDRESS =
  "EffectTalk <noreply@effecttalk.com>" as const;
