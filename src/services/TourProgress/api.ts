...
export const upsertStepProgress = (
  userId: string,
  stepId: string,
  status: TourProgressStatus,
  feedback?: string
...
export const bulkUpsertProgress = (
  userId: string,
  progress: ReadonlyArray<{ stepId: string; status: TourProgressStatus }>
) =>
  Effect.gen(function* () {
