...
console.log(
  "Wrote .env.local with generated WORKOS_COOKIE_PASSWORD (32+) and API_KEY_PEPPER."
);
console.log(
  "Replace WORKOS_API_KEY and WORKOS_CLIENT_ID in .env.local with values from WorkOS Dashboard."
);
