---
title: "A User Guide to the Effect Tour"
date: 2025-02-11
...
The guided tour at [/tour](/tour) is EffectTalk's structured learning path for Effect. It's organized into five groups, each covering a core area of Effect, with lessons that build on each other. Every lesson has multiple steps, each pairing an explanation with code you can read and run in the browser.
...
![Tour lesson index: Fundamentals and Composition groups with lesson cards; two lessons show the green Done badge.](/blog/tour-lesson-index.png)
...
![Single tour step: explanation and hints on the left, code editor with Anti-pattern/Solution tabs and console on the right, step navigation with circular indicators at the bottom.](/blog/tour-step-layout.png)
